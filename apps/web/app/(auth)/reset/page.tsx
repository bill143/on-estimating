    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50">
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md text-center">
          ...
          <p className="text-xs text-zinc-400">Click the link in the email to set a new password.</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <h2 className="text-lg font-semibold text-zinc-900 text-center mb-1">Reset your password</h2>
        <p className="text-sm text-zinc-500 text-center mb-6">Enter the email associated with your account and we&apos;ll send a reset link.</p>
