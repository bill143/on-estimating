...
// Dynamic-loaded tab components
const IntegrationsHub = dynamic(() => import('./tabs/IntegrationsHub'));
const AIConfiguration = dynamic(() => import('./tabs/AIConfiguration'));
const OrganizationProfile = dynamic(() => import('./tabs/OrganizationProfile'));
const UserManagement = dynamic(() => import('./tabs/UserManagement'));
const NotificationsAutomation = dynamic(() => import('./tabs/NotificationsAutomation'));
const EstimatingPreferences = dynamic(() => import('./tabs/EstimatingPreferences'));
const DocumentLibrary = dynamic(() => import('./tabs/DocumentLibrary'));
const BillingSubscription = dynamic(() => import('./tabs/BillingSubscription'));
const EchoSettings = dynamic(() => import('./tabs/EchoSettings'));

const tabs: { id: SettingsTab; label: string; icon: typeof Plug }[] = [
  { id: 'integrations', label: 'Integrations', icon: Plug },
  { id: 'ai-configuration', label: 'AI Configuration', icon: BrainCircuit },
  { id: 'echo', label: 'Echo AI', icon: Sparkles },
  { id: 'organization', label: 'Organization', icon: Building2 },
  { id: 'user-management', label: 'Users & RBAC', icon: Users },
