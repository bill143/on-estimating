...
const STUDIO_OUTPUTS: StudioOutputConfig[] = [
  {
    type: 'briefcast',
    label: 'Echo Briefcast',
    description: 'AI-generated audio discussion of your documents',
    icon: 'headphones',
    color: '#F97316',
  },
  {
    ...
    description: 'High-level summary with key findings and risks',
    icon: 'file-text',
    color: '#3B82F6',
  },
  {
    type: 'field_guide',
    label: 'Field Guide',
    description: 'Actionable reference for teams and estimators',
    icon: 'book-open',
    color: '#10B981',
  },
  {
  ...
  },
  {
    ...
    description: 'Chronological view of documents and milestones',
    icon: 'clock',
    color: '#F59E0B',
  },
  {
    type: 'document_map',
    label: 'Document Map',
    description: 'Table of contents and cross-reference index',
    icon: 'map',
    color: '#06B6D4',
  },
];
    ...
    <div className="flex flex-col h-full border-l border-zinc-200 bg-zinc-50/50">
      ...
      <div className="px-4 py-3 border-b border-zinc-200">
        ...
        <p className="text-[10px] text-zinc-400 mt-1">
          Generate AI-powered outputs from your sources
        </p>
      </div>
